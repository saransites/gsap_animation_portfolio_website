...
const CircleAnimation = () => {
  ...
  return (
    <div className="absolute right-1 bottom-1 md:right-2 md:bottom-2  w-[200px] h-[200px] rounded-full flex justify-center items-center ring-0 ring-slate-100 shadow-[0_0_10px_#fefefe] bg-slate-900 overflow-hidden">
      <div
