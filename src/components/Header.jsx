...
const Header = () => {
  ...
  return (
    ...
    >
      <ul className="head grid grid-cols-1 md:grid-cols-2 md:w-1/2 lg:max-w-full lg:grid-cols-3 ml-32 backdrop-blur-md p-3 rounded-full bg-opacity-50 shadow-[0_0_5rem_rgba(0,0,0,0.3)] bg-white/10">
        <li className="headlist group flex justify-center items-center gap-2 border-2 border-transparent rounded-full p-3 hover:bg-[#0000002b] transition duration-300 ease-in-out cursor-pointer">
